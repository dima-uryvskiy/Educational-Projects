...
подчёркивания "_". Стиль UpperCamelCase означает, что каждое слово пишется с большой буквы и разделителей между словами нет.
...
string_input = input().title().replace('_', '')
#  Сначала каждое слово сделал с заглавной буквы
#  затем заменил все _ на '',
print(string_input)